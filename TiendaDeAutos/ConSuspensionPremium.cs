...
{
    class ConSuspensionPremium:AbstractAutoDecorator
    {
        public ConSuspensionPremium(AbstractAuto autos) : base(autos)
        {
        }
        ...
        public override void mostrarAccesorios()
        {
            ...
            Console.WriteLine("Cuenta con suspension premium");
        }
    }
}
